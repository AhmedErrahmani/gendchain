// Package gendchain defines interfaces for interacting with GendChain.
package gendchain
...
type ChainReader interface {
	...
	// SubscribeNewHead subscribes to notifications about changes of the head block of the canonical chain.
