...
const (
	// bloomServiceThreads is the number of goroutines used globally by an GendChain
...
func (gc *GendChain) startBloomHandlers() {
...
// for the GendChain header bloom filters, permitting blazing fast filtering.
