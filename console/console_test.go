...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an GendChain service within
	...
	if err = stack.Register(func(sctx *node.ServiceContext) (node.Service, error) { return eth.New(sctx, ethConf) }); err != nil {
		t.Fatalf("failed to register GendChain protocol: %v", err)
	}
