...
import (
	...
	"github.com/ChainAAS/gendchain/internal/jsre"
	"github.com/ChainAAS/gendchain/internal/jsre/deps"
	"github.com/ChainAAS/gendchain/internal/web3ext"
...
// JavaScript console attached to a running node via an external or in-process RPC client.
type Console struct {
	client   *rpc.Client         // RPC client to execute Ethereum requests through
...
// Welcome shows summary of current GendChain instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the GendChain JavaScript console!\n\n"

	// Print some generic GendChain metadata
