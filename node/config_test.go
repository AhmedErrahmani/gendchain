...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gendchain.ipc", false, filepath.Join(os.TempDir(), "gendchain.ipc")},
		{"data", "gendchain.ipc", false, "data/gendchain.ipc"},
		{"data", "./gendchain.ipc", false, "./gendchain.ipc"},
		{"data", "/gendchain.ipc", false, "/gendchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gendchain.ipc", true, `\\.\pipe\gendchain.ipc`},
		{"data", "gendchain.ipc", true, `\\.\pipe\gendchain.ipc`},
		{"data", `\\.\pipe\gendchain.ipc`, true, `\\.\pipe\gendchain.ipc`},
	}
