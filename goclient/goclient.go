...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, gendchain.NotFound
...
func (ec *Client) SyncProgress(ctx context.Context) (*gendchain.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (gendchain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q gendchain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q gendchain.FilterQuery, ch chan<- types.Log) (gendchain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q gendchain.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg gendchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg gendchain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg gendchain.CallMsg) (uint64, error) {
...
// SnapshotAtHash returns the clique snapshot at the given block.
...
func toCallArg(msg gendchain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
