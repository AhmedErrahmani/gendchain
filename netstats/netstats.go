...
import (
	...
	"github.com/ChainAAS/gendchain/common/mclock"
...
// Service implements an GendChain netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server         // Peer-to-peer server to retrieve networking infos
	eth    *eth.GendChain      // Full GendChain service if monitoring a full node
	les    *les.LightGendChain // Light GendChain service if monitoring a light node
...
func New(cfg Config, ethServ *eth.GendChain, lesServ *les.LightGendChain) *Service {
