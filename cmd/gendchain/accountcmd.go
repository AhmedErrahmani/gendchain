...
var (
	walletCommand = cli.Command{
		...
		Description: `
    gendchain wallet import /path/to/my/presale.wallet

will prompt for your password and imports your ether presale account.
It can be used non-interactively with the --password option taking as argument a
password file containing the wallet password in plaintext.`,
		Subcommands: []cli.Command{
			{
				...
				Description: `
	gendchain wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    gendchain account update <address>
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gendchain account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    gendchain account import <keyfile>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gendchain account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := gendchainConfig{Node: defaultNodeConfig()}
	// Load config file.
