...
func loadConfig(file string, cfg *gendchainConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gendchain.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, gendchainConfig) {
	// Load defaults.
	cfg := gendchainConfig{
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the GendChain Stats daemon if requested.
	if cfg.Netstats.URL != "" {
