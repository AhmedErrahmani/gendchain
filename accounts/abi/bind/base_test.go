...
func (mc *mockCaller) CallContract(ctx context.Context, call gendchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call gendchain.CallMsg) ([]byte, error) {
